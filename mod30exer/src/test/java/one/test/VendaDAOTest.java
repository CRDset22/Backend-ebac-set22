...
import one.domain.dao.ClienteDAO;
import one.domain.dao.IClienteDAO;
import one.domain.dao.IProdutoDAO;
import one.domain.dao.IVendaDAO;
import one.domain.dao.ProdutoDAO;
import one.domain.dao.VendaDAO;
import domain.dao.generic.jdbc.ConnectionFactory;
import one.domain.Cliente;
import one.domain.Produto;
import one.domain.Venda;
import one.domain.Venda.Status;
